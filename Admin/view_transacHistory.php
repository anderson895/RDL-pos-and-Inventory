...
?>					
	...
	<td colspan="5"></td>
		...
		<td colspan="5" class="tr2"><h1  style="background-color:red; color: white; " class="tr1" style="font-size:30px" id="printPageButton" onClick="location.href='admin.php'">DONE</h1></td>
	</tr>
			</table> </div>
