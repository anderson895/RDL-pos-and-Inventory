...
<center>
  <ul>
  <li><a href="dashboard.php" class="logo" href="dashboard.php">
...
<button  name="search"><h1 class="hh1">SEARCH</h1><span class="glyphicon glyphicon-search"></span></button>
	...
	?>
      ...
      <form method="POST" >            
                                  ...
                                  <tr>
                                          <td class="sd" width="10%"> <?php echo $count; ?></td>
                                          <td class="sd" width="10%"> <?php echo $db_item_number=$fetch['item_number']; ?></td>
                                           <td class="sd" width="10%"> <?php echo $db_stocks=substr($fetch['stocks'], 0, 100);  ?></td>
                                          <td class="sd" width="5%"><?php echo $db_unit=$fetch['unit']; ?></td>
                                          <td class="sd" width="10%"> <?php echo $db_item_name=$fetch['item_name']; ?></td>
                                          <td class="sd" width="10%">₱ <?php echo number_format($db_orig_price=$fetch['orig_price'],2); ?> </td>
                                          <td class="sd" width="10%">₱ <?php echo number_format($db_orig_price=$fetch['price'],2); ?> </td>
                                           <td class="sd" width="10%"> 

                                          <input type="hidden" name="id" value="<?php echo $db_item_number=$fetch['item_number']?>">
                                          <input type="number" class="h1" type="number" min="1" max="100" name="qty" required placeholder="Input here" >


                                           </td>

                                          <td class="sd" width="40%"> 
                                ...
                                <tr>
                                        ...
                                        <td class="td1"> 
                                                   ...
                                                   <form method="POST">
                                                    ...
                                                    <button class="del1" type="submit" name="delete-item">DELETE</button>
                                                    </form>
...
foreach($c as $key => $value){
     ...
     $month = date('F');
        ...
        $insert="INSERT INTO `histoy` (`h_prod_id`, `h_qty`, `h_total`,h_date,bayad,tacking_number) VALUES ('$key', '$value','{$_POST['pricing']}',CURRENT_TIMESTAMP(),'{$_POST['bayad']}','$random')";
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <?php }
      ?>
       <input type="number" name="bayad" min="1" style="border: 1px solid black;" placeholder="Lagay mo dito yung bayad" required>
       <input type="text" id="pricing" name="pricing" style="border: 1px solid black;"  placeholder="babayaran"  readonly>
      </div>
