...
$item_number  = $_GET["deleteid"];

$get_record = mysqli_query($conn,"SELECT * FROM table_product WHERE item_number ='$item_number'");
...
mysqli_query($conn,"UPDATE table_product SET product_status='0' where item_number='$item_number' ");
	
	echo "<script>alert('Restore Item Successfully .');
 ...
 <div class="f">
 <form method="post">
		ARE YOU SURE YOU WANT TO RESTORE <?php echo strtoupper($db_item_name)?> ?<br>
		<button type="submit" name="yes" >YES</button>
		 <button type="submit" name="no" >NO</a></button>
 </form>
 </div>
