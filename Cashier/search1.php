...
$i_name=$i_price=$i_stock=$i_image="";
$i_nameErr=$i_priceErr=$i_stockErr=$i_imageErr="";
...
if($i_name && $i_price && $i_stock){
 ...
 date_default_timezone_set('Asia/Manila');
	 ...
	 mysqli_query($conn, "INSERT INTO `table_product`(`item_name`,`price`,`stocks`, `image`,`date_added`) VALUES ('$i_name','$i_price','$i_stock','$p_image','$day,$date')") or die('query failed');
...
?>
      ...
      <div class="right">
        ...
        <form method="POST" enctype="multipart/form-data">
           <h2 class="tran2">Add New Items</h2><br><br><br><br><br><br><br><br>
                <label class="ad">Item Name</label><br>
				
				<br> 
                <input class="b" type="text" name="i_name"><br><br> 
				
			<center>	<b><span class="error"><?php echo $i_nameErr; ?></span></b></center>
				<Br>
                <label class="ad">Price</label><br><br> 
                <input class="b" type="text" name="i_price"><br><br>  
			<center>	<b><span class="error"><?php echo $i_priceErr; ?></span></b></center>
				<Br>
                <label class="ad">Stock</label><br><br> 
			
                <input class="b" type="text" name="i_stock"><br><br>  
