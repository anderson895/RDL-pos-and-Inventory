    ...
    <section>
        <div class="left">
              <div class="left-up">
                   ...
                   <form method="POST" action="supplies_search.php">
              ...
              <div class="left-down"><br><br>
                      ...
                      <div class="scroll1">
						...
						<h2>Result</h2>
                                  ...
                                  <tr>
                                    <td class="sd" width="10%"> Item No.</td>
                                          <td class="sd" width="25%"> Item Name</td>
                                          <td class="sd" width="5%"> Unit</td>
                                          <td class="sd" width="10%"> Price</td> 
	...
	?>  
      <form method="POST" >            
                                  ...
                                  <tr>
										  ...
										  <?php echo $fetch['item_number']?>
										  
										  </td>
                                          <td class="sd" width="25%"><?php echo $fetch['item_name']?></td>
                                          <td class="sd" width="5%"><?php echo $fetch['unit']?></td>
                                          <td class="sd" width="10%"><?php echo $fetch['price']?></td>
                                          <td class="sd" width="10%"> <?php echo $fetch['stocks']?></td>
                                           <td class="sd" width="10%"> 
                            ...
                            <table class="or1">
                              ...
                              foreach($c as $key => $value){
                                ...
                                <tr>
                                        ...
                                        <td class="td1"> <?php echo $row['price']*$value?></td>
                                        <td class="td1"> 
  ...
  if(isset($_POST['confirm'])){
    ...
    //  echo '<pre>' . print_r($_POST, true) . '</pre>';
     ...
     $month = date('F');
        ...
        $insert="INSERT INTO `histoy` (`h_prod_id`, `h_qty`, `h_total`, `h_date`,bayad) VALUES ('$key', '$value','{$_POST['pricing']}','$month','{$_POST['bayad']}')";
