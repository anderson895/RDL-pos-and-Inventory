  ...
  <li><a class="active" class="a" href="settings.php">
      ...
      <section>
        <div class="left">
                ...
                <br><br>
               <button class="set" onclick="window.location.href='addnewunit.php';">Add Unit</button><br>
               <button class="set" onclick="window.location.href='remove_unit.php';">Remove Unit</button><br>
