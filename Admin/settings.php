  ...
  <li><a class="active" class="a" href="settings.php">
      ...
      <section>
        <div class="left">
                ...
                <br><br>
                <button class="set" onclick="window.location.href='changeUsername.php?userID=<?php echo $db_user_id ?>';">Change Username</button><br>
                <button class="set" onclick="window.location.href='changePassword.php?userID=<?php echo $db_user_id ?>';">Change Password</button><br>
                <button class="set" onclick="window.location.href='change_tax.php';">Change Tax Value</button><br>
                <button class="set" onclick="window.location.href='unit.php';">Manage Unit</button><br>
                <button class="set" onclick="window.location.href='adduser.php';">Add Users</button><br>
                <button class="set" onclick="window.location.href='itemarchive.php';">Item Archive</button><br>
                <button class="set" onclick="window.location.href='logout.php';">Logout</button><br>
